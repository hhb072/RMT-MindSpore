...
from RMT_mindspore import RMT_T, RMT_S, RMT_B, RMT_L
...
def main():
    ...
    parser.add_argument('--ckpt_path', default='/home/chao.jin/jinchao/model/RMT/RMT_mindspore/rmt-small-224.ckpt')
